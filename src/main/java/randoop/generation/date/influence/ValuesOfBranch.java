...
/**
 * .class 文件中（�?行行 JVM 指令），method 定义块里出现�? CMP 系列指令，我们称为分支结点�?�this class 记录�?个分支结点的属�?��?�每个分支结点的属�?�有�?
 * <li>�?在的 method
 * <li>是这�? method 里的第几个分支结点：relative_offset
 * <li>�? CMP 指令对应�? Java 源代码里的运算符是什么（�? >=）TODO 是否�?�?对应�?
 * <li>�? CMP 指令�?比较的两个操作数的�?�，转成 double TODO null 情况�?
 */
